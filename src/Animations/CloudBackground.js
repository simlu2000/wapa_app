    ...
    <div className="weather-animation">
      <Canvas camera={{ position: [0, -10, 10], fov: 75 }}>
        ...
        <CameraControls
          ...
          enabled={true}
          mouseButtons={{
            LEFT: THREE.MOUSE.ROTATE, // Permette la rotazione
            MIDDLE: null,             // Disabilita lo zoom con lo scroll
            RIGHT: THREE.MOUSE.PAN,   // Permette il pan (movimento laterale)
          }}
          touches={{
            ONE: THREE.TOUCH.ROTATE,  // Permette la rotazione con un dito
